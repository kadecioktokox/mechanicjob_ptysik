...
Config.Zones = {
	...
	MecanoActions = {
		Pos   =	{ x = -197.27, y = -1331.84, z = 30.89 },
		Size  = { x = 2.0, y = 2.0, z = 2.0 },
		Color = { r = 214, g = 47, b = 247 }, 
		Type  = 42,
	},


	MecanoActions2 = {
		Pos   =	{ x = 95561.17, y = -966346.5, z = -634639.51 },
