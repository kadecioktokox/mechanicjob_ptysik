Locales['en'] = {
  ...
  ['must_near']                 = 'musisz być ~p~blisko pojazdu~s~ aby go odholować.',
  ['vehicle_success_attached']  = 'pojazd ~p~przyłączony~s~',
  ['please_drop_off']           = 'proszę odstawić pojazd w garażu',
  ['cant_attach_own_tt']        = '~p~nie możesz~s~ podłączyć własnego holwnika',
  ['no_veh_att']                = 'nie ma ~p~pojazdu~s~ do podłączenia',
  ['not_right_veh']             = 'to nie jest prawidłowy pojazd',
  ['veh_det_succ']              = 'pojazd ~p~odłączony~s~!',
  ['imp_flatbed']               = '~p~Akcja niemożliwa!~s~ Potrzebujesz ~p~lawety~s~ aby załadować pojazd',
  ['objects']                   = 'objekty',
  ['roadcone']                  = 'pachołek',
  ...
  ['you_do_not_room']           = '~p~Nie masz wiecej miejsca',
  ['recovery_gas_can']          = 'odzyskiwanie ~p~Kanistra z paliwem~s~...',
  ['recovery_repair_tools']     = 'odzyskiwanie ~p~Części naprawczych~s~...',
  ['recovery_body_tools']       = 'odzyskiwanie ~p~Części blacharskich~s~...',
  ['not_enough_gas_can']        = 'nie posiadasz ~p~wystarczająco~s~ paliwa w kanistrze.',
  ['assembling_blowtorch']      = 'składanie ~p~Palnika~s~...',
  ['not_enough_repair_tools']   = 'nie posiadasz ~r~wystarczająco~s~ częsci naprawczych.',
  ['assembling_repair_kit']     = 'składanie ~p~częsci naprawczych~s~...',
  ['not_enough_body_tools']     = 'nie posiadasz ~r~wystarczająco~s~ częsci blacharskich.',
  ['assembling_body_kit']       = 'składanie ~p~częsci blacharskich~s~...',
  ['your_comp_earned']          = 'twoja firma ~p~zarobiła~s~ ~g~$',
  ['you_used_blowtorch']        = 'użyłeś ~p~palnik',
  ['you_used_repair_kit']       = 'użyłeś ~p~częsci naprawczych',
  ['you_used_body_kit']         = 'użyłeś ~p~częsci blacharskich',
  ['have_withdrawn']            = 'wyciągnąłeś ~y~x%s~s~ ~p~%s~s~',
  ['have_deposited']            = 'zdeponowałeś ~y~x%s~s~ ~p~%s~s~',
