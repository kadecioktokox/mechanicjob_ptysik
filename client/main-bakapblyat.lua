...
AddEventHandler('esx_mecanojob:onHijack', function()
  ...
  if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
    ...
    TaskPlayAnim(GetPlayerPed(-1), dict, "std_force_entry_rps", -1, -1, -1, 51, 1, false, false, false)
      Citizen.CreateThread(function()
		TriggerEvent("esx_anims:lockpick", true)
        ...
        if crochete <= 66 then
		  ...
		  TriggerEvent("esx_anims:lockpick", false)
        else
		  ClearPedTasksImmediately(playerPed)
